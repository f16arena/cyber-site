      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden border-b border-zinc-800/60">
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32">
            ...
            <h1 className="text-5xl sm:text-7xl font-display font-black tracking-tighter leading-[0.95] max-w-4xl">
            ...
            <p className="mt-8 text-xl sm:text-2xl text-zinc-400 max-w-2xl leading-relaxed">
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-violet-500/10 rounded-lg overflow-hidden border border-violet-500/20">
            {audienceFacts.map((fact, i) => (
              ...
              >
                <div className="text-3xl sm:text-4xl font-display font-black bg-gradient-to-b from-violet-300 to-violet-500 bg-clip-text text-transparent leading-tight">
                  {fact.value}
                </div>
        ...
        >
          <div className="rounded-xl border border-violet-500/30 bg-gradient-to-br from-violet-500/10 via-fuchsia-500/10 to-rose-500/10 p-8 sm:p-12">
            ...
            <h2 className="text-3xl sm:text-5xl font-display font-black tracking-tighter mb-3 leading-tight">
